  ...
  preconditions:
    - id: PRE-001
      condition: >-
        ...
        depth 10 capped at 20; getCardContext defaults to depth 3 at the ops
        layer (the CLI layer defaults to depth 1); getRelationGraph defaults to
        depth 3.
  ...
  postconditions:
    ...
    - id: POST-002
      guarantee: >-
        ...
        and the relation neighborhood up to the requested depth (CLI default 1
        hop; ops default 3). Truncation is signalled when nodes at the ceiling
