...
codeLinks:
  - kind: function
    file: src/glossary/validation.ts
    symbol: validateCardGlossaryField
  - kind: function
    file: src/glossary/validation.ts
    symbol: validateGlossaryEntry
  - kind: function
    file: src/glossary/cross-validate.ts
    symbol: buildGlossaryMatcher
glossary:
  - drift
spec:
  preconditions:
