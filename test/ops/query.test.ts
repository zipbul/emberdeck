...
describe('getCard', () => {
  ...
  it('should include history when includeHistory is true', async () => {
    tc = await createTestContext();
    await createCard(tc.ctx, { key: 'q-hist', summary: 'History', type: 'brief', body: BRIEF_BODY, brief: makeTestBrief() });
...
describe('getCards', () => {
  ...
  it('should include history when includeHistory is true', async () => {
    tc = await createTestContext();
    await createCard(tc.ctx, { key: 'gc-hist', summary: 'Hist', type: 'brief', body: BRIEF_BODY, brief: makeTestBrief() });
...
describe('listCards', () => {
  ...
  it('should return only cards with matching status when filter.status is provided', async () => {
    ...
    await createCard(tc.ctx, { key: 'flt-acc', summary: 'Active', type: 'brief', body: BRIEF_BODY, brief: makeTestBrief() });
